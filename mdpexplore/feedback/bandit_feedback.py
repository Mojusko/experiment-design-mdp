...
class BanditFeedback(SimpleFeedback):
    def __init__(self, env:MovementConstrainedBayesianOptimization, objective:RewardFunctional, estimator:GaussianProcess, theta_star:np.array, sigma:float, video:bool = False, markovian:bool = False) -> None:
