...
def main(cfg: DictConfig):
    ...
    # This logic has been moved to the Makefile to ensure the generated command is correct.
    # The python script now receives the correct cfg.algorithm from the start.
    # --- End Override ---
