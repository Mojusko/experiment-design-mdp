...
if __name__ == "__main__":
    ...
    parser.add_argument('--delta_mov', default= 0.05, type=float, help='Maximum movement constraint')
    ...
    if args.snake:
        ...
        convex_solver = LSR(env, objective=design, epsilon = func.gamma)
    if args.lsr:
        # define the convex solver
        convex_solver = LSR(env, objective=design, estimator=estimator)
