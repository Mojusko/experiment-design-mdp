...
p = 0.3
methods = ["adaptive-un-1","tracking-un", "density-un", "random-un"]
color = ["tab:blue", "tab:red", "tab:green", "tab:brown", "tab:purple"]
NAMES = ["OPTIMAL","TRACKING","RESAMPLING","RANDOM"]
...
plt.savefig("../figs/grid-example-p-03.png", dpi=100, bbox_inches='tight', pad_inches=0)
plt.show()
