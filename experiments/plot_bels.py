...
plot(ax, methods, COLORS, name, "beilschmiedia/results/", [1,2**9], 'a)', 'Beilschmiedia: variance bound')
...
plot(ax, methods, COLORS, name, "beilschmiedia/results/", [1,2**9], 'b)', 'Beilschmiedia: estimating variance')
...
plt.savefig("figs/grids-subplots-bels.png",dpi = 100, bbox_inches = 'tight',pad_inches = 0)
plt.show()
